...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.ws.rest.exception;
 ...
 */
public class IllegalAccessWebException extends WebApplicationException {
     ...
     *
     */
    public IllegalAccessWebException(final String pComposant, final Integer pErrorCode, final String pErrorDescription) {
     ...
     */
    private IllegalAccessWebException(final String pMessage) {
