...
public class TechnicalWebException extends WebApplicationException {
     ...
     *
     */
    public TechnicalWebException(final String pComposant, final Integer pErrorCode, final String pErrorDescription) {
     ...
     */
    private TechnicalWebException(final String pMessage) {
